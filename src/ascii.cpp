...
namespace lxd {
    namespace ascii_internal {
        ...
        // zero-initialized.
        DLL_PUBLIC const unsigned char kPropertyBits[256] = {
        ...
        DLL_PUBLIC const char kToLower[256] = {
    ...
    int memcasecmp(const char* s1, const char* s2, size_t len) {
        ...
        for(size_t i = 0; i < len; i++) {
            const int diff =
                int{static_cast<unsigned char>(lxd::ascii_tolower(us1[i]))} -
                int{static_cast<unsigned char>(lxd::ascii_tolower(us2[i]))};
