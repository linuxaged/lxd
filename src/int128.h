...
//#endif  // byte order
    ...
    DLL_PUBLIC extern const uint128 kuint128max;
...
namespace std {
    template <>
    class numeric_limits<lxd::uint128> {
    public:
        ...
        static constexpr lxd::uint128(min)() { return 0; }
        static constexpr lxd::uint128 lowest() { return 0; }
        static constexpr lxd::uint128(max)() { return lxd::Uint128Max(); }
        static constexpr lxd::uint128 epsilon() { return 0; }
        static constexpr lxd::uint128 round_error() { return 0; }
        static constexpr lxd::uint128 infinity() { return 0; }
        static constexpr lxd::uint128 quiet_NaN() { return 0; }
        static constexpr lxd::uint128 signaling_NaN() { return 0; }
        static constexpr lxd::uint128 denorm_min() { return 0; }
    };
}  // namespace std
...
namespace std {
    template <>
    class numeric_limits<lxd::int128> {
    public:
        static constexpr bool is_specialized = true;
        ...
        static constexpr lxd::int128(min)() { return lxd::Int128Min(); }
        static constexpr lxd::int128 lowest() { return lxd::Int128Min(); }
        static constexpr lxd::int128(max)() { return lxd::Int128Max(); }
        static constexpr lxd::int128 epsilon() { return 0; }
        static constexpr lxd::int128 round_error() { return 0; }
        static constexpr lxd::int128 infinity() { return 0; }
        static constexpr lxd::int128 quiet_NaN() { return 0; }
        static constexpr lxd::int128 signaling_NaN() { return 0; }
        static constexpr lxd::int128 denorm_min() { return 0; }
    };
}  // namespace std
